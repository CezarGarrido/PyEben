...
class NewForm(Gtk.Window):
    __gsignals__ = {
        "employee_added": (GObject.SignalFlags.RUN_FIRST, None, (int,)),  # Agora aceita um argumento tipo str
    }
        
    def __init__(self, app, parent):
        super().__init__(title="Novo Funcionário")
