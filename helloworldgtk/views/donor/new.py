...
class NewForm(Gtk.Window):
    __gsignals__ = {
        "donor_added": (GObject.SignalFlags.RUN_FIRST, None, (int,)),  # Agora aceita um argumento tipo str
    }
        
    def __init__(self, app, parent):
        super().__init__(title="Novo Doador")
    ...
    def on_save_clicked(self, widget):
        ...
        try:
            ...
            id = service.create(self.app.logged_user, donor)
            
            print(f"donor_added ID: {id}")
            self.emit("donor_added", id)  
